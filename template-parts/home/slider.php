<section class="main-slider" data-loop="true" data-autoplay="true" data-interval="7000">
    ...
    <!-- Slide One -->
    <div class="slide slideResize slide1" style="background-image: url(<?php echo get_template_directory_uri() ?>/img/home/home-slider-1.jpg);">
        <div class="container">
    ...
    <!-- Slide Two -->
    <div class="slide slideResize slide2" style="background-image: url(<?php echo get_template_directory_uri() ?>/img/home/home-slider-2.jpg);">
        <div class="container">
    ...
    <!-- Slide Three -->
    <div class="slide slideResize slide3" style="background-image: url(<?php echo get_template_directory_uri() ?>/img/home/home-slider-3.jpg);">
        <div class="container">
        <div class="common-inner slide-inner3">
            <img src="<?php echo get_template_directory_uri() ?>/img/favicon.png" alt="Logo Icon" class="img-responsive">
    ...
    <!-- Slide Four -->
    <div class="slide slideResize slide4" style="background-image: url(<?php echo get_template_directory_uri() ?>/img/home/home-slider-4.jpg);">
        <div class="container">
